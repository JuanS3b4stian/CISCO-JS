...
/* Exercise 2: Modify the previous program so that it asks the user for the first and last number it uses 
...
let n1 = prompt("Write the initial value: ")
let n2 = prompt("Write the final value: ")

if (n1 > n2) {
    alert("The initial value can't be greater than the final value, try it again");
} 
...
for (evenNumber of numbers) {
    if (evenNumber % 2 === 0) {
        console.log(evenNumber);
    }
}

console.log("----------Larger than 10 and smaller than 60 Numbers ----------")
for (largerAndSmallerNumber of numbers) {
    if (largerAndSmallerNumber > 10 && largerAndSmallerNumber < 60) {
        console.log(largerAndSmallerNumber);
    }
}
...
/* Exercise 5: The contents of the object describing the position of the vessel 
 named "Mareno" are written on the console: 
